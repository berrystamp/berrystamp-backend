...
public interface OrderService {
    ...
    OrderRequest createNewOrderRequest(PrintRequestDto printRequestDto, Long designId);
//    OrderRequest createNewOrderRequest(OrderRequestCreation orderRequestCreation);
}
